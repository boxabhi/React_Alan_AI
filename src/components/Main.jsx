...
const  Main = (props) => {
    ...
    useEffect(()=>{
        ...
        alanBtn = alanBtn({ 
            ...
            onCommand: ({command , savedArticles ,response}) => {
              if (command === 'getNews') {
               ...
               return  prevCurrent + 1
                ...
                setWeather(response)
                  ...
                  window.open('https://www.youtube.com/channel/UC2zu5Ms9MQWg7-OonfCO47g')
              }
...
//     )
    ...
    return (
        <div>
            ...
            {
                Object.keys(news).length > 0  ?   <Cards news={news} current={current} /> : <Start/>   
            }
